...
if __name__ == "__main__":
    ...
    generation_strategy = GenerationStrategy(
        steps=[
            GenerationStep(model=Generators.SOBOL, num_trials=5),   # SOBOL, GPEL, MOO, GPMultiObjective
            GenerationStep(model=Generators.BOTORCH_MODULAR, num_trials=5),  # MOBO continues indefinitely
        ]
    )
